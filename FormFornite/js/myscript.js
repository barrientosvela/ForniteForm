...
function validaContrasena(){
        ...
        var contrasena1 = document.getElementById("c1").value;
        var contrasena2 = document.getElementById("c2").value;
        var campoC2 = document.getElementById("c2");

        if(contrasena1===contrasena2){
                campoC2.style.border = "none";
                document.getElementById("checkPass").style.display = 'block';
                valido++;                                
        }else{
                campoC2.style.border = "red solid 3px";
...
function enviar(){
        ...
        if(valido >= 5){
                ...
                window.location.href = "https://www.epicgames.com/fortnite/es-ES/home";
        }else{
